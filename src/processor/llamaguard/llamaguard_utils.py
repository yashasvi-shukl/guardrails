...
# Initializing short name for each llamaguard versions
...
# Initializing category and it's definition for all llamaguard version
...
def create_conversation(messges: List[str]) -> List[ConversationTurn]:
    """
    Function to identify current input is from user or from agent
...
def build_default_prompt(
    ...
    """
    function to generate prompt based on llamaguard version
    """
...
def build_custom_prompt(
    ...
    """
    function to build prompt in llamaguard specific format
